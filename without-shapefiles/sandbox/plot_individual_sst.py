...
start_date = datetime(2015, 6, 1)   # datetime(2015, 7, 1)
end_date = datetime(2015, 6, 2)  # datetime(2016, 7, 1)
...
for n in range(int((end_date - start_date).days)):
    ...
    if len(ff) > 0:
        ...
        sname = 'avhrr_individual_plt_{}.png'.format(f[:-10])
        ...
        plotMap(sfile, 'AVHRR pass {}'.format(f[:-10]), sst)
