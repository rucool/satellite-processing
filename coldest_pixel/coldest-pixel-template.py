...
# define domain
# (these correspond to 9km WRF domain)
minlat=31
maxlat=47.33
minlon=-83.25
maxlon=-56.9

# grab MURSST grid and file attributes
...
# MUR mask includes options for land, ocean, lake, ocean with ice, lake with ice
# cut back options to land (1) or water (0)
...
lon_var=temp.createVariable('lon','f4',('lon',))
lat_var=temp.createVariable('lat','f4',('lat',))
z_var=temp.createVariable('z','f4',('z',))
...
temp.comment=["Timestamps with data provided in 'composite_start_time' " +
    ...
    "MUR SST grid taken from http://basin.ceoe.udel.edu/thredds/dodsC/NASAMURSST.nc."]
...
temp.contributor_name="Scott Glenn, Travis Miles, Michael Crowley, Joe Brodie, Laura Nazzaro, Lori Garzio"
temp.contributor_role="Principal Investigator, Principal Investigator, Satellite Operations, Director of Atmospheric Research, Data Manager, Data Manager"
temp.date_created=''
temp.date_modified=''
...
mask_var.long_name='water/land mask'
